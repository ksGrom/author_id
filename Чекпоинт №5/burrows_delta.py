"""
Реализация одного из классических методов определения
авторства. В проекте используется только для сравнения 
с обучаемыми моделями. Взято из открытого источника.
